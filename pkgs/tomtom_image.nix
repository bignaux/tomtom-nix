...

{
  ...
  system.build.tomtom_image = let
    ...
    '';
  in pkgs.runCommand "tomtom_image" {} ''
    mkdir $out
    cd $out
    ...
    cp ${./../bcm2710-tomtom-3-b.dtb} bcm2710-tomtom-3-b.dtb
  ...
  nixpkgs.config.packageOverrides = pkgs: {
    linux_tomtom = pkgs.callPackage ./linux-tomtom.nix {};
  };
}
